                            ...
                            <div class="row border-top py-3 mt-3">
                                ...
                                <div class="col-sm-2 text-right">
                                    <div class="font-size-20 text-danger font-baloo">
                                        Rp<span class="product_price" data-id="<?php echo $item['item_id'] ?? '0'; ?>">
                                            <?php echo number_format($item['item_price'], 0, ',', '.'); ?>
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="border-top py-4">
                        <h5 class="font-baloo font-size-20">
                            ...
                            <span class="text-danger">
                                Rp<span class="text-danger" id="deal-price">
                                    <?php echo isset($subTotal) ? number_format($Cart->getSum($subTotal), 0, ',', '.') : 0; ?>
                                </span>
                            </span>
                        </h5>
